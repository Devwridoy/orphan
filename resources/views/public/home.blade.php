...
<p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias nemo et, esse laudantium consequatur. Eum soluta illum architecto dolorum quae suscipit dignissimos! Saepe, amet explicabo nemo eligendi totam sint repudiandae.</p>
<p><a href="#" class="btn btn-outline-primary">Adopt a child now</a></p>

          </div>
          <div class="col-md-1"></div>
          <div class="col-md-6">
            <h2 class="mb-5">Steps to adopt &amp; foster a child</h2>
            <div id="accordion">
              <div class="card mb-2">
                <h5 class="mb-0">
          ...
          @foreach($orphan_view as $row)
            <div>
              <div class="media d-block media-custom text-left">
                <a href="#"><img src="{{ URL::to($row -> image) }}" alt="Image Placeholder" class="img-fluid"></a>
