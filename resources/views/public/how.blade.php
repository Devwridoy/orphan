            ...
            <div class="col-md-7 col-sm-12 element-animate">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">How To Adopt</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4 order-2 sidebar">
            ...
            <div class="sidebar-box">
              ...
              <ul class="list-unstyled sidelink">
                ...
                <li class="active"><a href="#">How to Adopt</a></li>
              </ul>
            </div>            
          ...
          <div class="col-md-8 order-1 main">
            <div class="row">
              ...
              <div class="col-md-12">
                <h2 class="mb-4 text-primary">1. Getting Started</h2>
                ...
                <p class="mb-5">Molestias nesciunt sequi dignissimos, illo laboriosam deserunt. Mollitia distinctio at ipsam expedita, quo explicabo impedit optio! Et quam at impedit, fugiat. Repudiandae dolore, nemo saepe molestiae optio earum ratione a ipsum voluptatum. Nam et aperiam consequatur odit laudantium labore itaque nihil veritatis repellat distinctio officiis quod pariatur possimus facilis quia, eum, voluptas sint quasi dignissimos aliquid illum a dicta optio.</p>
                <h2 class="mb-5 text-primary">2. Envisioning Your Family</h2>
                <p class="element-animate" data-animate-effect="fadeIn"><img src="{{asset('/fontend/img/work_thumb_2.jpg')}}" alt="Image placeholder" class="img-fluid"></p>
